...
import { Lock, ShieldCheck, HelpCircle, Mail, CheckCircle2, KeyRound } from "lucide-react";
          ...
          <div className="mt-6 bg-white border border-slate-200 rounded-xl p-5">
            <div className="flex items-start gap-3">
              ...
              <p className="text-base text-slate-700 leading-relaxed">
                ...
                sign-in links, passwords, private documents, financial information, or meeting materials outside the family.
              </p>
            </div>
          </div>
          ...
          {showHelp && (
            <div className="mt-4 bg-slate-100 border border-slate-200 rounded-xl p-5 text-base text-slate-700" data-testid="help-panel">
              <p className="mb-2">
                ...
                <a className="text-blue-900 underline" href="mailto:stephen@cloudpoweredtech.com">stephen@cloudpoweredtech.com</a>.
              </p>
              <p>
